...
private void promptHealer( Character character, Scanner Input, GameSystem gs, Displayer ds) {
    ...
    System.out.print(character.GetFullName() + " the " + character.GetName() + "'s turn.");
                                    ...
                                    if (abilityChoice == 2 && character.CheckAbility2Possible(gs)) {
                                        ...
                                        System.out.println(character.GetFullName() + " the " + character.GetName() + " buffs " + target.GetFullName() + " the " + target.GetName() );
                                    }
                                        ...
                                        if ( success ){
                                        System.out.println(character.GetFullName() + " the " + character.GetName() + " casts energy bolt on " + target.GetFullName() + " the " + target.GetName() );
                                        }
                                        else {
                                        ...
                                        System.out.print(character.GetFullName() + " the " + character.GetName() + " is unable to cast Energy Bolt. ");
                                    }
                                    else {
...
private void promptCrusader (Character character, Scanner Input, GameSystem gs, Displayer ds) {
    if (character.CheckAbility1Possible(gs)) {
                                    ...
                                    if (abilityChoice == 1 && character.CheckAbility1Possible(gs) ) {
                                        ...
                                        if ( success){
                                        System.out.println(character.GetFullName() + " the " + character.GetName() + " shields " + target.GetFullName() + " the " + target.GetName() + "!");
                                        }
                                        else {
                                            System.out.println("noob");
                                        }
                        ...
                        while (!HasSelected) {
                            ...
                            if (Choice == 1) {
                               System.out.println("Necromancer \nA disturbed warlock who conjures and manipulates the dead. \nAbilities: \nAbility 1: Summon Minion - Summons a weak minion to fight. ");
                                System.out.println("Ability 2: Buff Minion - Buffs an adjacent minion \nAbility \3: Meat Shield - Sacrafice an adjacent minion to tank a hit.");
                                ...
                                System.out.println("Ability 2: Praise - Grants an ally +4 intl and +2 spirit. \nAbility 3: Strike - Weak attack that may stun.");
                                System.out.println("Stat buffs: \n+0 speed\n+3 intelligence\n-1 attack\n+3 spirit\n+2 health\n+1 spellpower");
                                System.out.println("Would you like to select this class? (y/N)");
                                String confirm = Input.next();
                                if (confirm.equalsIgnoreCase("Y")) {
                                ...
                                System.out.println("Crusader \nA highly poised warrior who both safeguards allies and threatens moderate damage.\nAbilities: \nAbility 1: Divine Shield - Creates a protective barrier around an adjacent ally. ");                                System.out.println("Ability 1: Holy Light - Heals an adjacent ally. \nAbility 2: Condemn - Deals damage to an enemy.");
                                System.out.println("Ability 2: Holy Light - Heals an adjacent ally. \nAbility 3: Condemn - Deals damage to an enemy.");
                                System.out.println("Stat buffs: \n+0 speed\n+2 intelligence\n+1 attack\n+1 spirit\n+3 health\n+1 spellpower");
                                System.out.println("Would you like to select this class? (y/N)");
                                String confirm = Input.next();
                                if (confirm.equalsIgnoreCase("Y")) {
                                ...
                                System.out.println("Ability 2: Rage Strike - Melee attack dealing massive damage. \nAbility 3: Lupus - The barbarian damages himself and gains a permanent damage increase.");
                                System.out.println("Stat buffs: \n+2 speed\n-1 intelligence\n+8 attack\n+1 spirit\n-2 health\n+0 spellpower");                                System.out.println("Would you like to select this class? (y/N)");
                                String confirm = Input.next();
                                if (confirm.equalsIgnoreCase("Y")) {
                                    SelectedClass = 4;
                                    HasSelected = true;
